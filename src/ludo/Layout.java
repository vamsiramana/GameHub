...
public class Layout {
	...
	public Layout(int xi,int yi,String p1,String p2,String p3,String p4) {
            pl[0] = p1;
            pl[1] = p2;
            pl[2] = p3;
            pl[3] = p4;
	...
	public void draw(Graphics2D g){
        ...
        g.drawString(pl[0], 90, 35);
        g.drawString(pl[1], 370, 35);
        g.drawString(pl[3], 90, 540);
        g.drawString(pl[2], 370, 540);
